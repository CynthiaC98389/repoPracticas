...
public class poo27Nov {
	...
	public poo27Nov (String nombre, String apellido, int edad, double salario, String puesto) {
		//super();
	...
	public String toString() {
		return "PooJava [nombre=" + nombre + ", apellido=" + apellido + ", edad=" + edad + ", salario=" + salario
				+ ", puesto=" + puesto + "]";
	}
